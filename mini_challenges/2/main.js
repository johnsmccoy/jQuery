...
//3. Add a event listener to the input field with id "keypress-input"
//  so that on keypress, the value in the input field is displayed in 
// the div with id "output-target".

$('#keypress-input').keyup(function(){
    $('#output-target').html($('#keypress-input')
    .val());
});
  
//4. When the mouse moves anywhere on the article with class "main-article",
//  log to the console "The mouse is moving!".
